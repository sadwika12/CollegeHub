...
const DEMO_ACCOUNTS = [
  { email: "yagna@college.com",    label: "Student"       },
  { email: "ramesh@college.com",   label: "Faculty"       },
  { email: "priya@college.com",    label: "HOD"           },
  { email: "sharma@college.com",   label: "Dean"          },
  { email: "admin@college.com",    label: "Admin"         },
  { email: "examcell@college.com", label: "Exam Cell"     },
  { email: "cdp@college.com",      label: "CDP Cell"      },
  { email: "library@college.com",  label: "Library Cell"  },
  { email: "mitra@college.com",    label: "Student Mitra" },
  { email: "sdcac@college.com",    label: "SDCAC"         },
  { email: "hands@college.com",    label: "Helping Hands" },
  { email: "literary@college.com", label: "Literary Club" },
]
...
const GlobalStyles = () => (
  <style>{`
    ...
    .ch-up-1   { animation: chUp 0.5s ease both 0.12s; }
    .ch-up-2   { animation: chUp 0.5s ease both 0.24s; }
    .ch-up-3   { animation: chUp 0.5s ease both 0.36s; }
    ...
    input { font-family:'DM Sans',sans-serif !important; color:#d4cde8 !important; }
...
const AcademicIllustration = () => (
  <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <circle cx="200" cy="152" r="80" fill="url(#iCG)"/>
    ...
    <g style={{ transformOrigin:"200px 106px", animation:"chBobCap 3.2s ease-in-out infinite" }}>
      <rect x="168" y="92" width="64" height="8" rx="3" fill="url(#iCapG)" filter="url(#iGlow)"/>
      <rect x="194" y="82" width="12" height="12" rx="2" fill="url(#iCapG)"
      ...
      <circle cx="241" cy="119" r="3.5" fill="#9b7dd4" filter="url(#iGlow)"/>
    ...
    <g style={{ transformOrigin:"92px 210px", animation:"chBobBook 3.8s ease-in-out 0.5s infinite" }}>
      ...
      <rect x="58" y="206" width="8"  height="15" rx="2" fill="#7c5cbf" filter="url(#iGlow)"/>
      <rect x="64" y="190" width="50" height="17" rx="3" fill="#5c3fa0" stroke="rgba(155,125,212,0.7)" strokeWidth="1"/>
      <rect x="64" y="190" width="9"  height="17" rx="2" fill="#9b7dd4" filter="url(#iGlow)"/>
    </g>
    <g style={{ transformOrigin:"298px 212px", animation:"chBobAtom 4.1s ease-in-out 1s infinite" }}>
      <circle cx="298" cy="212" r="9"  fill="url(#iAtomG)" filter="url(#iGlow)"/>
    ...
    <g style={{ transformOrigin:"76px 82px", animation:"chBobPencil 3.5s ease-in-out 0.8s infinite" }}>
      <rect x="68" y="54" width="14" height="50" rx="3" fill="url(#iPencilG)"/>
    ...
    <g style={{ transformOrigin:"314px 76px", animation:"chBobBulb 3.9s ease-in-out 1.4s infinite" }}>
      <circle cx="314" cy="70" r="26" fill="rgba(124,92,191,0.07)" filter="url(#iSoftGlow)"/>
      <path d="M299 70 Q299 48 314 44 Q329 48 329 70 Q329 82 321 88 L307 88 Q299 82 299 70Z"
        fill="url(#iBulbG)" opacity="0.9" filter="url(#iGlow)"/>
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center p-5 relative overflow-hidden"
        ...
        <div className="ch-card flex w-full overflow-hidden relative z-10"
          style={{ maxWidth:"960px", height:"580px", borderRadius:"18px",
          ...
          <div className="relative flex flex-col overflow-hidden"
            ...
            <div className="relative z-10 flex-shrink-0">
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="flex items-center justify-center rounded-xl flex-shrink-0"
                  style={{ width:"40px", height:"40px",
                    background:"linear-gradient(135deg,#5c3fa0,#7c5cbf)",
                    boxShadow:"0 4px 18px rgba(124,92,191,0.55)" }}>
              ...
              <div style={{ width:"44px", height:"2px", borderRadius:"2px", marginBottom:"14px",
                background:"linear-gradient(90deg,#7c5cbf,rgba(124,92,191,0))" }}/>
              ...
              <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"1.7rem", fontWeight:700, color:"#e8e0f8", lineHeight:1.3, marginBottom:"8px", maxWidth:"260px" }}>
                Knowledge is{" "}
                <em style={{ fontStyle:"italic", color:"#9b7dd4" }}>the brightest</em>{" "}
                light you carry
              </h2>

              <p style={{ fontSize:"0.76rem", fontWeight:300, color:"rgba(180,160,230,0.5)", lineHeight:1.65, maxWidth:"255px", marginBottom:"14px" }}>
                Announcements, events, clubs, and classmates — everything your academic journey needs.
              </p>
          ...
          <div className="flex flex-col justify-center relative overflow-hidden"
            style={{ flex:"1", padding:"36px 42px",
            ...
            <div className="ch-up-1" style={{ marginBottom:"2px" }}>
              <div style={{ fontSize:"0.62rem", fontWeight:600, letterSpacing:"3px", textTransform:"uppercase", color:"#7c5cbf", marginBottom:"4px" }}>
                Student Portal
              </div>
              <h1 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"2.6rem", fontWeight:700, color:"#e8e0f8", lineHeight:1, marginBottom:"6px" }}>
                Welcome
              </h1>
              <div style={{ width:"34px", height:"2px", borderRadius:"2px", background:"linear-gradient(90deg,#5c3fa0,#9b7dd4)", marginBottom:"8px" }}/>
              <p style={{ fontSize:"0.76rem", color:"rgba(180,160,230,0.43)", fontWeight:300, marginBottom:"20px" }}>
                Sign in with your college email to continue
              </p>
            </div>

            
            <form onSubmit={handleSubmit} className="w-full ch-up-2">

            
              <div className="relative mb-4">
                <label style={{ position:"absolute", top:"-8px", left:"13px", padding:"0 4px",
                ...
                <div className="ch-field flex items-center rounded-xl"
                  ...
                  <div className="flex items-center justify-center flex-shrink-0" style={{ width:"42px", color:"#7c5cbf" }}>
                  ...
                  <input
                    ...
                    style={{ padding:"11px 12px 11px 0", fontSize:"0.84rem" }}
                  />
                </div>
              </div>
              ...
              {(formError || error) && (
                <div className="rounded-xl mb-3 mt-3"
                  style={{ background:"rgba(220,38,38,0.09)", border:"1px solid rgba(220,38,38,0.28)", color:"#fca5a5", padding:"9px 14px", fontSize:"0.79rem" }}>
                  {formError || error}
                </div>
              )}
              ...
              <button type="submit" disabled={loading}
                className="ch-btn w-full rounded-xl text-white relative overflow-hidden disabled:opacity-50 mt-4 mb-3"
              ...
              <p className="text-center mb-3" style={{ fontSize:"0.76rem", color:"rgba(180,160,230,0.43)" }}>
                Don't have an account?{" "}
                <Link to="/register" style={{ color:"#9b7dd4", fontWeight:600, textDecoration:"none", borderBottom:"1.5px solid rgba(155,125,212,0.38)", paddingBottom:"1px" }}>
                  Register Now
                </Link>
              </p>

              
              <div className="ch-up-3 rounded-xl"
                style={{ background:"rgba(124,92,191,0.08)", border:"1px solid rgba(124,92,191,0.18)", padding:"10px 14px" }}>
                <p style={{ fontSize:"0.62rem", fontWeight:600, color:"rgba(155,125,212,0.65)", marginBottom:"6px", letterSpacing:"1.5px", textTransform:"uppercase" }}>
                ...
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"2px 12px" }}>
                  {DEMO_ACCOUNTS.map((u) => (
                    <button key={u.email} type="button"
                      ...
                      style={{ fontSize:"0.68rem", color:"rgba(155,125,212,0.52)", background:"none", border:"none", cursor:"pointer", padding:"1px 0", fontFamily:"'DM Sans',sans-serif", textAlign:"left", transition:"color .15s" }}
                      onMouseOver={e => e.currentTarget.style.color="#9b7dd4"}
                      onMouseOut={e  => e.currentTarget.style.color="rgba(155,125,212,0.52)"}>
                      <span style={{ fontWeight:600, color:"rgba(180,160,230,0.8)" }}>{u.label}</span>
                    </button>
                  ))}
                </div>
              </div>
